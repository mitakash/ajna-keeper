...
var universalRouterModule = __importStar(require("../universal-router-module"));
var nonce_1 = require("../nonce");
describe('Universal Router Module', function () {
    var swapStub;
    var mockSigner;
    ...
    beforeEach(function () {
        ...
        swapStub = sinon_1.default.stub(universalRouterModule, 'swapWithUniversalRouter');
    });
    it('should approve token for Permit2 if allowance is insufficient', function () { return __awaiter(void 0, void 0, void 0, function () {
        var tokenAddress, targetTokenAddress, amount, slippage, universalRouterAddress, permit2Address, feeTier, poolFactoryAddress, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    slippage = 50;
                    universalRouterAddress = '0xUniversalRouterAddress';
                    permit2Address = '0xPermit2Address';
                    feeTier = 3000;
                    poolFactoryAddress = '0xPoolFactoryAddress';
                    // Return success to simulate a successful call
                    swapStub.resolves({ success: true, receipt: { transactionHash: '0xSuccess' } });
                    return [4 /*yield*/, universalRouterModule.swapWithUniversalRouter(mockSigner, tokenAddress, amount, targetTokenAddress, slippage, universalRouterAddress, permit2Address, feeTier, poolFactoryAddress)];
                case 1:
                    result = _a.sent();
                    ...
                    (0, chai_1.expect)(swapStub.firstCall.args[4]).to.equal(slippage);
                    // Verify the result
    ...
    it('should handle errors during swap', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, universalRouterModule.swapWithUniversalRouter(mockSigner, '0xTokenAddress', ethers_1.BigNumber.from('1000000'), '0xTargetTokenAddress', 50, '0xUniversalRouterAddress', '0xPermit2Address', 3000, '0xPoolFactoryAddress')];
                case 1:
                    result = _a.sent();
                    (0, chai_1.expect)(result.success).to.be.false;
                    (0, chai_1.expect)(result.error).to.equal('Swap failed');
                    return [2 /*return*/];
            }
        });
    }); });
    ...
    describe('Specific behaviors', function () {
...
//# sourceMappingURL=universal-router-module.test.js.map