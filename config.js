...
var config = {
    dryRun: true,
    logLevel: 'info',
    ethRpcUrl: 'https://eth-mainnet.g.alchemy.com/v2/wk4a7Xefsrk759nNkp1RR',
    subgraphUrl: 'https://api.studio.thegraph.com/query/49479/ajna-base/version/latest',
    keeperKeystore: '/Users/bigdellis/keystore-files/keeper-keystore.json',
    ...
    ajna: {
        ...
        grantFund: '0x74d5b005ca64a5C9EE3611Bdc6F6C02D93C84b2f',
        burnWrapper: '0x936Ab482d6bd111910a42849D3A51Ff80BB0A711',
        lenderHelper: '',
    },
    coinGeckoApiKey: 'CG-fCqhCoxEKUGV5bM6fYnUcRDG',
    pools: [
        {
            name: 'wstETH / WETH',
