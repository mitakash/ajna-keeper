...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var factoryAddress, expectedV4Taker, factory, currentV4Taker;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, hardhat_1.ethers.getContractAt(['function takerContracts(uint8) view returns (address)'], factoryAddress)];
                case 1:
                    factory = _a.sent();
